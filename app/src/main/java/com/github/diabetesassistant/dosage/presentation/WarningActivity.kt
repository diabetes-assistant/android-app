...
class WarningActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (errorType == 1) {
            binding.warningTextView
                .setText(getString(R.string.calculate_dosage_glucose_level_too_high))
        } else if (errorType == 2) {
            // Blutzuckerspiegel zu niedrig
            binding.warningTextView
                .setText(getString(R.string.calculate_dosage_glucose_level_too_low))
        }
    }
